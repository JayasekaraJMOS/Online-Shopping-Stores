      ...
      <div class="grid lg:grid-cols-3 gap-8">
          ...
          <div v-else class="space-y-4">
            ...
            <div class="bg-[var(--card-bg)] border border-[var(--border-color)] p-5 flex justify-between items-center rounded-2xl shadow-md">
              ...
              <div class="flex gap-3 text-[10px] font-black uppercase tracking-tighter">
                <button @click="cart.selectAll" class="text-[var(--accent-color)] hover:underline">Select All</button>
        ...
        <div class="lg:col-span-1">
          <div class="bg-[var(--card-bg)] border border-[var(--border-color)] p-8 rounded-2xl sticky top-24 shadow-2xl overflow-hidden">
            ...
            <h2 class="text-xs font-black uppercase border-b border-[var(--border-color)] pb-4 mb-6 tracking-[0.2em] text-[var(--text-muted)]">Order Summary</h2>
            ...
            <p v-if="cart.selectedCount === 0" class="text-[10px] text-red-500 font-bold text-center mt-3 uppercase tracking-tighter">Please select items to proceed</p>
          </div>
        </div>
      </div>
    </div>
